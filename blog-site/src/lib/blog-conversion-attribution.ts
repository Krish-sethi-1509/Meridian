...
export const BLOG_CONVERSION_SOURCE = 'meridian-blog';
...
export const BLOG_PRODUCT_URLS: Record<BlogProductDestination, string> = {
  dashboard: 'https://www.meridian.app/dashboard',
  pro: 'https://www.meridian.app/pro',
  api: 'https://www.meridian.app/docs/api-reference',
  mcp: 'https://www.meridian.app/docs/mcp-quickstart',
};
