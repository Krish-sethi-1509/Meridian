...
description: "Score your trade lanes for chokepoint exposure, subscribe to disruption webhooks, and pipe alerts to Slack with this Meridian API tutorial."
metaTitle: "Supply Chain Risk API: Chokepoint Alerts | Meridian"
...
The second group did not have a $50,000-a-year risk platform. The capability they used, [live chokepoint tracking](/blog/posts/tracking-global-trade-routes-chokepoints-freight-costs/) with programmatic alerts, is part of Meridian's API. This post builds that early-warning system end to end: score your lanes, subscribe to alerts, verify deliveries, and route them to Slack.

You need an API key (`X-Meridian-Key`, issued with [Pro or API plans](https://www.meridian.app/pro)) and about an afternoon.
...
Total code: one webhook receiver and two cron jobs. If you want to stress-test the design, the [scenario engine](https://www.meridian.app/docs/scenario-engine) simulates events like a Taiwan Strait closure or a Panama drought against live trade data. AI agents can run the same checks conversationally through the [MCP server](/blog/posts/meridian-mcp-server-ai-agents-real-time-intelligence/).

## Primary Trade Sources

Validate trade signals against primary datasets such as the [WTO API portal](https://apiportal.wto.org/) and [UN Comtrade](https://comtradeplus.un.org/). Meridian adds normalization and cross-domain context; the originating institution remains the authority for its underlying series.

## Frequently Asked Questions

**Which chokepoints can I monitor?**

All 13 strategic waterways Meridian tracks, including the Strait of Hormuz, Suez Canal, Bab el-Mandeb, Strait of Malacca, Panama Canal, Taiwan Strait, Bosporus, Kerch Strait, and the Cape of Good Hope bypass corridor.
...
**Get an API key at [meridian.app/pro](https://www.meridian.app/pro), pull the full OpenAPI spec from [meridian.app/openapi.yaml](https://www.meridian.app/openapi.yaml), and ship the early-warning system your freight forwarder thinks you bought from someone expensive.**
