...
description: "Explore six free Meridian dashboards for geopolitics, technology, finance, commodities, positive news, and energy, all built on one platform."
metaTitle: "6 Intelligence Dashboards, One Platform | Meridian"
...
heroImage: "/blog/images/blog/five-dashboards-one-platform-meridian-variants.jpg"
pubDate: "2026-02-12"
...
Meridian runs **six specialized dashboards** from a single codebase. Switch between them with one click. Each variant curates panels, layers, and data feeds for its specific audience while sharing the same underlying intelligence engine, map infrastructure, and AI capabilities.

## 1. Meridian: The Geopolitical Command Center

**URL:** meridian.app
**Panels:** 102
**Focus:** Conflicts, military, infrastructure, geopolitical risk

This is the flagship. Meridian is built for OSINT analysts, defense researchers, journalists, and anyone who needs to [understand global security dynamics](/blog/posts/track-global-conflicts-in-real-time/).
...
- Integration with Meridian's conflict and disaster layers
...
The variants share a single codebase. Every improvement to the core engine benefits all six dashboards simultaneously. A map performance optimization for Meridian automatically makes Commodity Monitor faster too.
...
But when you need to cross domains (the commodity trader wants to check if a conflict is affecting mining operations), switching to Meridian is one click away.
...
- [meridian.app](https://www.meridian.app) for geopolitics
- [tech.meridian.app](https://tech.meridian.app) for technology
- [finance.meridian.app](https://finance.meridian.app) for markets
- [commodity.meridian.app](https://commodity.meridian.app) for commodities
- [happy.meridian.app](https://happy.meridian.app) for good news
- [energy.meridian.app](https://energy.meridian.app) for energy
