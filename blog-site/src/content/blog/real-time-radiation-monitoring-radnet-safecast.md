...
description: "Meridian merges EPA RadNet stations and the Safecast citizen-sensor network into a live radiation layer, with nuclear sites and IAEA irradiators for context."
metaTitle: "Real-Time Radiation Monitoring Map | Meridian"
...
It's also one of the best-instrumented hazards on Earth. The sane response to a radiation rumor is to read the sensor networks — which is exactly what Meridian's Radiation Watch does.
...
Because no public sensors report there. Coverage follows sensor deployment, not risk. Meridian shows gaps as gaps rather than interpolating reassuring values.

**What should I do if readings genuinely rise near me?**

Follow official emergency guidance for your area. Meridian is a situational-awareness tool for understanding events; it is not an emergency-alert or civil-defense system.
