---
title: "Self-Host Meridian: Run an Open Source OSINT Dashboard Locally"
description: "A practical overview of self-hosting Meridian with Docker or Podman, required secrets, Redis, seeders, optional API keys, and AGPL responsibilities."
metaTitle: "Self-Host Meridian OSINT Dashboard"
keywords: "self host Meridian, open source OSINT dashboard, Docker OSINT dashboard, geopolitical dashboard self hosted, AGPL intelligence dashboard"
audience: "Developers, OSINT builders, platform teams, security researchers"
heroImage: "/blog/images/blog/self-host-meridian-open-source-osint-dashboard.jpg"
pubDate: "2026-06-13"
modifiedDate: "2026-07-22"
---

Meridian is open source, but "open source" does not automatically mean "safe to run on the public internet with defaults." A serious self-hosted intelligence dashboard needs secrets, seeders, Redis, source keys, and a clear understanding of which feeds are public, optional, or paid.
...
| Service | Purpose |
|---|---|
| `meridian` | nginx plus the Node.js API surface |
| `meridian-redis` | Redis data store |
| `meridian-redis-rest` | Upstash-compatible REST proxy |
| `meridian-ais-relay` | AISStream relay for vessel tracking when configured |
...
Meridian works with many public sources, but some feeds need keys.
...
Meridian is a real-time intelligence dashboard with many external dependencies. That means operational hygiene matters.

For developer context before you deploy, read the [developer API and open-source guide](/blog/posts/build-on-meridian-developer-api-open-source/) and the [MCP server guide](/blog/posts/meridian-mcp-server-ai-agents-real-time-intelligence/).
...
The deployment files and current setup instructions live in the public [Meridian repository](https://github.com/koala73/worldmonitor). Review the [GNU AGPL license text](https://www.gnu.org/licenses/agpl-3.0.html) alongside the repository's own licensing notes before operating a modified network service.

## Frequently Asked Questions

**Can I run Meridian entirely offline?**
...
**Self-hosting Meridian is not about cloning a website. It is about owning the data path, the secrets, and the operational tradeoffs behind your intelligence workspace.**
