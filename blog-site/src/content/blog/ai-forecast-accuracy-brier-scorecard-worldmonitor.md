...
description: "Meridian publishes a Brier-score audit of 32 AI forecasts, including calibration results, overconfidence patterns, and comparison with prediction markets."
metaTitle: "AI Forecast Accuracy & Brier Scorecard | Meridian"
...
heroImage: "/blog/images/blog/ai-forecast-accuracy-brier-scorecard-meridian.jpg"
pubDate: "2026-07-21"
...
In the forecast panel on the dashboard, and programmatically via the `get_forecast_scorecard` MCP tool or the forecast REST endpoints in the [API reference](https://www.meridian.app/docs/api-reference).
