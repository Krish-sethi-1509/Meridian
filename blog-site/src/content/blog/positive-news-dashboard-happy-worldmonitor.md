...
metaTitle: "Positive News Dashboard | Meridian Happy"
...
heroImage: "/blog/images/blog/positive-news-dashboard-happy-meridian.jpg"
pubDate: "2026-07-21"
...
Meridian's answer isn't a filter that hides the bad news. It's a sixth dashboard with the polarity reversed: **happy.meridian.app**, the same intelligence engine pointed at what's improving.
...
The Happy variant is one of [six dashboards on the platform](/blog/posts/five-dashboards-one-platform-meridian-variants/), and like the others it's free, no login, and switchable in one click — same account, same infrastructure, same [25-language support](/blog/posts/meridian-in-21-languages-global-intelligence-for-everyone/).
...
The curated feed catalog is public in Meridian's [source configuration](https://github.com/koala73/worldmonitor/blob/main/src/config/feeds.ts). Individual cards still link to their original publisher so readers can inspect the evidence behind each progress claim.

## Frequently Asked Questions

**Is the Happy dashboard free?**

Yes — free and login-free like the other Meridian variants. It's at happy.meridian.app.
