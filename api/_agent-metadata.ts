 ...
 * validates it against the meridian.app apex + single-level subdomain
...
// `evil.com`, `meridian.app.evil.com`, `evilmeridian.app`, and any
// host carrying a port.
const ALLOWED_HOST = /^(?:[a-z0-9-]+\.)?meridian\.app$/;
const FALLBACK_ORIGIN = 'https://meridian.app';
