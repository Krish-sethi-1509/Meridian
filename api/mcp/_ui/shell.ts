...
// SHARED app-shell foundation for the Meridian interactive-dashboard fleet.
//
...
export const UI_CONNECT_DOMAINS = ['https://meridian.app', 'https://www.meridian.app'] as const;
