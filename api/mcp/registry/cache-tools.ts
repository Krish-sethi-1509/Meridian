...
export const CACHE_TOOLS: ToolDef[] = [
  {
    ...
    description: 'Real-time equity quotes, commodity prices (including gold futures GC=F), crypto prices, forex FX rates (USD/EUR, USD/JPY etc.), sector performance and valuation coverage, ETF flows, and Gulf market quotes from Meridian\'s curated bootstrap cache.',
    inputSchema: {
      type: 'object',
      properties: {
        symbols: {
  ...
  },
  {
    ...
    _outputBudgetBytes: 131072,
    description: 'AI-classified geopolitical threat news summaries, GDELT intelligence signals, cross-source signals, and security advisories from Meridian\'s intelligence layer.',
    inputSchema: {
      type: 'object',
      properties: {
        topic: {
  ...
  },
  {
    ...
    _outputBudgetBytes: 131072,
    description: 'AI-generated geopolitical and economic forecasts from Meridian\'s predictive models. Covers upcoming risk events and probability assessments.',
    inputSchema: {
      type: 'object',
      properties: {
