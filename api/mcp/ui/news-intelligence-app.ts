...
// country, source provenance) from Meridian's intelligence layer. Built on the shared
// shell foundation.
//
...
const BODY = `
  <div class="head">
    ...
    <div class="badge">Meridian Intelligence</div>
  </div>
...
export const NEWS_INTELLIGENCE_APP_HTML = buildAppHtml({
  title: 'News Intelligence — Meridian',
  appName: 'meridian-news-intelligence',
  styles: STYLES,
  body: BODY,
  renderBody: RENDER,
});
