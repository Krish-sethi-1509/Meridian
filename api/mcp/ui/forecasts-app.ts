...
// interactive app shell for the `get_forecast_predictions` tool: Meridian's
...
const BODY = `
  <div class="head">
    ...
    <div class="badge">Meridian Forecasts</div>
  </div>
...
export const FORECASTS_APP_HTML = buildAppHtml({
  title: 'Forecasts — Meridian',
  appName: 'meridian-forecasts',
  styles: STYLES,
  body: BODY,
  renderBody: RENDER,
});
