...
<meta http-equiv="Content-Security-Policy" content="default-src 'none'; script-src 'unsafe-inline'; style-src 'unsafe-inline'; img-src 'self' data:; connect-src 'self' https://meridian.app https://www.meridian.app; frame-ancestors https://chatgpt.com https://claude.ai https://claude.com; form-action 'none'; base-uri 'none'">
<title>Country Risk — Meridian</title>
<style>
  :root {
...
(function () {
  ...
  post({
    ...
    params: {
      ...
      appInfo: { name: "meridian-country-risk", version: "1.0.0" },
      appCapabilities: {}
    }
  });
})();
