...
import { safeHttpUrl } from '../server/meridian/intelligence/v1/_company-shared';
import {
  MATERIAL_ITEM_CODES,
...
import { getCompanyEnrichment } from '../server/meridian/intelligence/v1/get-company-enrichment';
import { listCompanySignals } from '../server/meridian/intelligence/v1/list-company-signals';
import { searchSecFilings } from '../server/meridian/intelligence/v1/search-sec-filings';
...
describe('getCompanyEnrichment', () => {
  ...
  it('declares a User-Agent on the direct Upstash CIK registry read', async () => {
    ...
    assert.match(userAgent, /Meridian/);
  });
