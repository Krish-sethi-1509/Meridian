...
function buildHtml({ canonical, xdefault, alternates, jsonld } = {}) {
  const parts = [];
  parts.push(canonical ?? '<link rel="canonical" href="https://www.meridian.app/dashboard" />');
  if (xdefault !== null) {
    parts.push(xdefault ?? '<link rel="alternate" hreflang="x-default" href="https://www.meridian.app/dashboard" />');
  }
  parts.push(...(alternates ?? [
    '<link rel="alternate" hreflang="en" href="https://www.meridian.app/dashboard" />',
  ]));
...
describe('validateIndexLanguageMetadata', () => {
  ...
  it('flags an x-default href that carries a ?lang param', () => {
    const failures = validateIndexLanguageMetadata(STATS, buildHtml({
      xdefault: '<link rel="alternate" hreflang="x-default" href="https://www.meridian.app/dashboard?lang=en" />',
    }));
  ...
  it('flags a pseudo-localized query-string alternate', () => {
    const failures = validateIndexLanguageMetadata(STATS, buildHtml({
      alternates: [
        '<link rel="alternate" hreflang="en" href="https://www.meridian.app/dashboard" />',
        '<link rel="alternate" hreflang="fr" href="https://www.meridian.app/dashboard?lang=fr" />',
      ],
    }));
    assert.ok(hit(failures, 'hreflang set must contain only x-default and en'));
  ...
  it('flags x-default and English alternates that drift from the canonical', () => {
    const failures = validateIndexLanguageMetadata(STATS, buildHtml({
      xdefault: '<link rel="alternate" hreflang="x-default" href="https://www.meridian.app/" />',
      alternates: ['<link rel="alternate" hreflang="en" href="https://www.meridian.app/" />'],
    }));
