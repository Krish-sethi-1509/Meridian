...
} from '../server/meridian/supply-chain/v1/_multi-sector-shock.ts';
...
// ========================================================================
// 2. sebuf handler: server/meridian/supply-chain/v1/get-multi-sector-cost-shock.ts
// ========================================================================

describe('getMultiSectorCostShock sebuf handler', () => {
  const src = readSrc('server/meridian/supply-chain/v1/get-multi-sector-cost-shock.ts');
