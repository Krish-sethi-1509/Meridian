...
} from '../server/meridian/market/v1/backtest-stock.ts';
import { listStoredStockBacktests } from '../server/meridian/market/v1/list-stored-stock-backtests.ts';
import { MarketServiceClient } from '../src/generated/client/meridian/market/v1/service_client.ts';
...
describe('technical-only backtest disclosure', () => {
  it('labels the panel and persistent namespaces independently from live composite ratings', () => {
    ...
    const storeSource = readFileSync(
      new URL('../server/meridian/market/v1/premium-stock-store.ts', import.meta.url),
      'utf8',
    );
