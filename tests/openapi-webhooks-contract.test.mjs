...
// (public/openapi.json ← docs/api/meridian.openapi.yaml) must name the
...
// sends (server/meridian/shipping/v2/deliver-webhook.ts).

const root = resolve(dirname(fileURLToPath(import.meta.url)), '..');
const bundlePath = resolve(root, 'docs/api/meridian.openapi.yaml');
const deliverPath = resolve(root, 'server/meridian/shipping/v2/deliver-webhook.ts');
