...
import { adaptSnapshot } from '../server/meridian/intelligence/v1/get-regional-snapshot';

const __dirname = dirname(fileURLToPath(import.meta.url));
const root = resolve(__dirname, '..');

const handlerSrc = readFileSync(
  resolve(root, 'server/meridian/intelligence/v1/get-regional-snapshot.ts'),
  'utf-8',
);
...
const protoSrc = readFileSync(
  resolve(root, 'proto/meridian/intelligence/v1/get_regional_snapshot.proto'),
  'utf-8',
);
