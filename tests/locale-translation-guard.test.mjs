...
describe('translation validation', () => {
  ...
  describe('host-qualified paths without a scheme', () => {
    ...
    const REAL = 'See meridian.app/docs/api-keys for step-by-step help.';
    ...
    it('rejects rewriting a bare-domain URL', () => {
      assert.equal(
        validateTranslation(REAL, 'Siehe meridian.app/fr/docs/cles-api für Hilfe.'),
        false,
      );
    });
    ...
    it('accepts a preserved bare-domain URL', () => {
      assert.equal(
        validateTranslation(REAL, 'Siehe meridian.app/docs/api-keys für Schritt-für-Schritt-Hilfe.'),
        true,
      );
    });
  ...
  describe('absolute URLs', () => {
    it('rejects a dropped URL', () => {
      assert.equal(
        validateTranslation('Read https://meridian.app/pro now', 'Lisez maintenant'),
        false,
      );
    });
    ...
    it('rejects a rewritten URL', () => {
      assert.equal(
        validateTranslation('Read https://meridian.app/pro now', 'Lisez https://meridian.app/fr/pro'),
        false,
      );
    });
    ...
    it('accepts a preserved URL', () => {
      assert.equal(
        validateTranslation('Read https://meridian.app/pro now', 'Lisez maintenant https://meridian.app/pro'),
        true,
      );
    });
  });
