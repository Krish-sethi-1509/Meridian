 ...
 *   - server/meridian/cyber/v1/_shared.ts
 *   - server/meridian/military/v1/get-usni-fleet-report.ts
 *   - server/meridian/news/v1/_shared.ts  (+ dedup.mjs + hash.ts)
 *   - server/meridian/infrastructure/v1/get-cable-health.ts
 *
...
import {
  ...
  SEVERITY_RANK,
  type RawThreat,
} from '../server/meridian/cyber/v1/_shared.ts';
...
} from '../server/meridian/military/v1/get-usni-fleet-report.ts';
import type { USNIFleetReport } from '../src/generated/server/meridian/military/v1/service_server.ts';

// ---------------------------------------------------------------------------
// News domain helpers
// ---------------------------------------------------------------------------
import { deduplicateHeadlines } from '../server/meridian/news/v1/dedup.mjs';
import { buildArticlePrompts, hashString, selectUniqueHeadlinePairs } from '../server/meridian/news/v1/_shared.ts';
...
import {
  ...
  processNgaSignals,
  computeHealthMap,
} from '../server/meridian/infrastructure/v1/get-cable-health.ts';
