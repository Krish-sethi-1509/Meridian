...
import { assignStoryIdentity, deduplicateHeadlines } from '../server/meridian/news/v1/dedup.mjs';
...
describe('list-feed-digest story-identity wiring (#4924 review)', () => {
  const digestSrc = readFileSync(
    resolve(dirname(fileURLToPath(import.meta.url)), '../server/meridian/news/v1/list-feed-digest.ts'),
    'utf-8',
  );
...
import { adoptExistingCanonical } from '../server/meridian/news/v1/dedup.mjs';
