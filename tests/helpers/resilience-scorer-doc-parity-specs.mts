...
import { MACRO_FISCAL_INDICATOR_WEIGHTS } from '../../server/meridian/resilience/v1/_macro-fiscal-weights.ts';
import type { ResilienceDimensionId } from '../../server/meridian/resilience/v1/_dimension-scorers.ts';
...
const SCORER_SOURCE_PATH = resolve(here, '../../server/meridian/resilience/v1/_dimension-scorers.ts');
