...
const PROTO_PATH = 'proto/meridian/supply_chain/v1/supply_chain_data.proto';
const SHIPPING_PROTO_PATHS = {
  response: 'proto/meridian/supply_chain/v1/get_shipping_rates.proto',
};
const GENERATED_SERVER_PATH = 'src/generated/server/meridian/supply_chain/v1/service_server.ts';
...
describe('Handler cache-only (get-shipping-rates.ts)', () => {
  const handlerSrc = readFileSync(resolve(root, 'server/meridian/supply-chain/v1/get-shipping-rates.ts'), 'utf-8');
