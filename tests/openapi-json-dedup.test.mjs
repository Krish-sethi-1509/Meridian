...
function resolveSharedChinaProvenanceRefs(spec) {
  const refPrefix =
    '#/components/schemas/meridian_intelligence_v1_ChinaDecisionSignalProvenanceClaims/';
...
describe('dedupeSharedChinaProvenanceSchemas (fixture)', () => {
  it('reuses only structurally identical known-value schemas across the two China surfaces', () => {
    ...
    const spec = {
      components: {
        schemas: {
          meridian_supply_chain_v1_ChinaCorridorProvenance: {
            properties: {
              claims: {
                properties: {
                  publisher: {
          ...
          meridian_intelligence_v1_ChinaDecisionSignalProvenanceClaims: {
            properties: {
              publisher: {
                oneOf: [
                  {
    ...
    assert.equal(
      spec.components.schemas.meridian_supply_chain_v1_ChinaCorridorProvenance
        .properties.claims.properties.publisher.oneOf[0].properties.value.$ref,
      '#/components/schemas/meridian_intelligence_v1_ChinaDecisionSignalProvenanceClaims/properties/publisher/oneOf/0/properties/value',
    );
    assert.deepEqual(
      spec.components.schemas.meridian_supply_chain_v1_ChinaCorridorProvenance
