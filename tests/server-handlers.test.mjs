...
describe('aggregateHapiConflictEvents (scripts/_conflict-hapi.mjs)', () => {
  // #5554: server/meridian/conflict/v1/get-humanitarian-summary.ts no longer
...
describe('getHumanitarianSummary handler (cache-only)', () => {
  const src = readSrc('server/meridian/conflict/v1/get-humanitarian-summary.ts');
...
describe('humanitarian_summary.proto', () => {
  const proto = readSrc('proto/meridian/conflict/v1/humanitarian_summary.proto');
...
describe('LLM prompt political context (LOW-1)', () => {
  const src = readSrc('server/meridian/news/v1/_shared.ts');
...
describe('getCacheKey determinism', () => {
  ...
  const sharedSrc = readSrc('server/meridian/news/v1/_shared.ts');
...
describe('getVesselSnapshot caching (HIGH-1)', () => {
  const src = readSrc('server/meridian/maritime/v1/get-vessel-snapshot.ts');
...
describe('getSimulationOutcome handler', () => {
  const src = readSrc('server/meridian/forecast/v1/get-simulation-outcome.ts');
