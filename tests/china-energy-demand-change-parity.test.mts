...
import { buildChinaCorridorSourceBundle } from '../server/meridian/supply-chain/v1/china-corridor-source-adapters';
import { buildChinaActivityNowcastInputs } from '../server/meridian/economic/v1/get-china-activity-nowcast';
...
describe('China energy-demand change crosses every runtime seam (#6067)', () => {
  ...
  it('pins the reviewed basis literal on both sides of the runtime boundary', () => {
    ...
    const sources = [
      'server/meridian/economic/v1/get-china-activity-nowcast.ts',
      'server/meridian/supply-chain/v1/china-corridor-source-adapters.ts',
