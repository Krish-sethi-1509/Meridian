...
import { TEMPORAL_ANOMALIES_TTL } from '../server/meridian/infrastructure/v1/_shared.ts';
import { listTemporalAnomalies } from '../server/meridian/infrastructure/v1/list-temporal-anomalies.ts';
...
describe('temporal anomalies cache freshness', () => {
  ...
  it('refreshes the data key and seed-meta on fresh cache hits', () => {
    const src = readFileSync(
      resolve(ROOT, 'server/meridian/infrastructure/v1/list-temporal-anomalies.ts'),
      'utf8',
    );
