...
export const SITE_ORIGIN = 'https://www.meridian.app';
...
export const STATIC_ROUTE_MANIFEST = Object.freeze([
  ...
  route('https://meridian.app/mcp', 'mcp', [
    'api/mcp.ts',
    'api/mcp',
  ...
  route('https://tech.meridian.app/dashboard', 'dashboard-variant', [
    ...DASHBOARD_MATERIAL_SOURCES,
    'src/config/variants/tech.ts',
  ]),
  route('https://finance.meridian.app/dashboard', 'dashboard-variant', [
    ...DASHBOARD_MATERIAL_SOURCES,
    'src/config/variants/finance.ts',
  ]),
  route('https://commodity.meridian.app/dashboard', 'dashboard-variant', [
    ...DASHBOARD_MATERIAL_SOURCES,
    'src/config/variants/commodity.ts',
  ]),
  route('https://happy.meridian.app/dashboard', 'dashboard-variant', [
    ...DASHBOARD_MATERIAL_SOURCES,
    'src/config/variants/happy.ts',
  ]),
  route('https://energy.meridian.app/dashboard', 'dashboard-variant', [
    ...DASHBOARD_MATERIAL_SOURCES,
