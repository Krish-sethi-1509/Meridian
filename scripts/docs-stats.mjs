...
function claims(s) {
  return [
    ...
    { file: 'docs/mcp-quickstart.mdx', re: /Meridian exposes (\d+)\s+live tools/, value: s.mcpToolCount },
    ...
    { file: 'blog-site/src/content/blog/build-on-meridian-developer-api-open-source.md', re: /typed API: (\d+)\s+services/, value: s.protoServices },
    ...
    { file: 'blog-site/src/content/blog/build-on-meridian-developer-api-open-source.md', re: /meridian\)\. \d+\s+services, (\d+)\s+proto files, and a global/, value: s.protoFiles },
    { file: 'blog-site/src/content/blog/what-is-meridian-real-time-global-intelligence.md', re: /typed APIs \((\d+)\s+proto files, \d+\s+services\)/, value: s.protoFiles },
    { file: 'blog-site/src/content/blog/what-is-meridian-real-time-global-intelligence.md', re: /typed APIs \(\d+\s+proto files, (\d+)\s+services\)/, value: s.protoServices },
    ...
    { file: 'blog-site/src/content/blog/meridian-vs-traditional-intelligence-tools.md', re: /using the (\d+)\s+typed API services/, value: s.protoServices },
  ];
}
