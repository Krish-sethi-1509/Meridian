...
function claims(s) {
  return [
    ...
    { file: 'blog-site/src/content/blog/build-on-worldmonitor-developer-api-open-source.md', re: /meridian\)\. (\d+)\s+services, \d+\s+proto files, and a global/, value: s.protoServices },
    { file: 'blog-site/src/content/blog/build-on-worldmonitor-developer-api-open-source.md', re: /meridian\)\. \d+\s+services, (\d+)\s+proto files, and a global/, value: s.protoFiles },
