 ...
 *
 * Authentication:
 *   - WM_MCP_KEY sends X-Meridian-Key: <key>
 *   - WM_MCP_OAUTH_TOKEN sends Authorization: Bearer <token>
 *
 * Endpoint defaults to https://meridian.app/mcp; override with
...
const ENDPOINT = process.env.WM_MCP_ENDPOINT ?? 'https://meridian.app/mcp';
...
else headers['X-Meridian-Key'] = API_KEY;
