...
// without a usable discovery timestamp. We persist a Meridian-observed
...
// Issue #4008 — pure merge of Meridian-observed first-seen. Resolves one
...
async function fetchAllThreats() {
  ...
  // Meridian-observed) before sort/proto so `firstSeenAt` is populated for
