...
const REQUIRED_REGISTRATIONS = Object.freeze([
  ...
  ['api/mcp/_registry/rpc-tools.ts', 'get_china_decision_signals', ROUTE, CANONICAL_KEY],
  ...
  ['server/routes/bootstrap.js', 'chinaDecisionSignals: {', "s-maxage=900"],
  ['server/routes/health.js', 'chinaDecisionSignals: BOOTSTRAP_CACHE_KEYS.chinaDecisionSignals', `key: '${META_KEY}'`],
  ['server/routes/seed-health.js', `'intelligence:china-decision-signals': { key: '${META_KEY}'`],
...
export const CHINA_DECISION_STRUCTURAL_CHECKS = Object.freeze([
  Object.freeze({
    ...
    file: 'server/routes/seed-health.js',
...
export const CHINA_DECISION_PARITY_USER_AGENT =
  'meridian-china-parity-audit/1.0 (+https://meridian.app)';
