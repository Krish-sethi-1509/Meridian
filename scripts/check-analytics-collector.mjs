...
const DEFAULT_COLLECTOR_ORIGIN = 'https://abacus.meridian.app';
export const ANALYTICS_CANARY_WEBSITE_ID = '373c80a2-1109-42a7-868b-565bcf7bf168';
const ANALYTICS_CANARY_HOSTNAME = 'analytics-canary.meridian.app';
/**
 ...
 * not cosmetic.
 */
const USER_AGENT = 'meridian-analytics-collector-monitor/1.0';
...
const ANALYTICS_CANARY_PAYLOAD = Object.freeze({
  ...
  title: 'Meridian analytics collector canary',
  referrer: '',
  screen: '1x1',
  language: 'en-US',
