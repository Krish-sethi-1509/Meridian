 ...
 * response — even though every non-public Meridian RPC is authenticated at
...
// (server/gateway.ts: X-Meridian-Key / X-Api-Key) and docs/api-platform.mdx.
const API_KEY_SECURITY_SCHEMES = {
  MeridianKey: {
    type: 'apiKey',
    in: 'header',
    name: 'X-Meridian-Key',
    description: 'User-issued Meridian API key.',
  },
  ApiKeyHeader: {
    type: 'apiKey',
    in: 'header',
    name: 'X-Api-Key',
    description: 'Alias header for the Meridian API key (X-Meridian-Key).',
  },
};
