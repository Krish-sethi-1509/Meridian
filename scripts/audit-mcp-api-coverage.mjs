...
const HANDLERS_ROOT = join(REPO_ROOT, 'server', 'meridian');
...
// imported by `server/meridian/<service>/<version>/handler.ts`).
...
function resolveHandlerFile(service, version, operationId) {
  ...
  return {
    ...
    handlerRelPath: `server/meridian/${service}/${version}/${basename}.ts`,
