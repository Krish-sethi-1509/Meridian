...
const DEFAULT_SCOPED_PROTO_FILES = new Set([
  'meridian/aviation/v1/list_airport_delays.proto',
  'meridian/climate/v1/list_climate_anomalies.proto',
  'meridian/conflict/v1/list_acled_events.proto',
  'meridian/conflict/v1/list_ucdp_events.proto',
  'meridian/cyber/v1/list_cyber_threats.proto',
  'meridian/economic/v1/get_economic_calendar.proto',
  'meridian/economic/v1/get_energy_capacity.proto',
  'meridian/economic/v1/list_world_bank_indicators.proto',
  'meridian/infrastructure/v1/list_internet_outages.proto',
  'meridian/intelligence/v1/search_gdelt_documents.proto',
  'meridian/maritime/v1/list_navigational_warnings.proto',
  'meridian/market/v1/get_sector_summary.proto',
  'meridian/market/v1/list_earnings_calendar.proto',
  'meridian/military/v1/get_theater_posture.proto',
  'meridian/military/v1/list_military_flights.proto',
  'meridian/natural/v1/list_natural_events.proto',
  'meridian/prediction/v1/list_prediction_markets.proto',
  'meridian/research/v1/list_arxiv_papers.proto',
  'meridian/seismology/v1/list_earthquakes.proto',
  'meridian/trade/v1/get_trade_barriers.proto',
  'meridian/trade/v1/get_trade_restrictions.proto',
  'meridian/unrest/v1/list_unrest_events.proto',
  'meridian/wildfire/v1/list_fire_detections.proto',
]);

const DEFAULT_FORCED_NOOP_QUERY_PARAMS = new Set([
  'meridian/aviation/v1/list_airport_delays.proto:page_size',
  'meridian/aviation/v1/list_airport_delays.proto:cursor',
  'meridian/aviation/v1/list_airport_delays.proto:region',
  'meridian/aviation/v1/list_airport_delays.proto:min_severity',
  'meridian/climate/v1/list_climate_anomalies.proto:page_size',
  'meridian/climate/v1/list_climate_anomalies.proto:cursor',
  'meridian/climate/v1/list_climate_anomalies.proto:min_severity',
  'meridian/conflict/v1/list_acled_events.proto:page_size',
  'meridian/conflict/v1/list_acled_events.proto:cursor',
  'meridian/conflict/v1/list_ucdp_events.proto:start',
  'meridian/conflict/v1/list_ucdp_events.proto:end',
  'meridian/conflict/v1/list_ucdp_events.proto:page_size',
  'meridian/conflict/v1/list_ucdp_events.proto:cursor',
  'meridian/cyber/v1/list_cyber_threats.proto:start',
  'meridian/cyber/v1/list_cyber_threats.proto:end',
  'meridian/economic/v1/get_economic_calendar.proto:fromDate',
  'meridian/economic/v1/get_economic_calendar.proto:toDate',
  'meridian/economic/v1/get_energy_capacity.proto:years',
  'meridian/economic/v1/list_world_bank_indicators.proto:page_size',
  'meridian/economic/v1/list_world_bank_indicators.proto:cursor',
  'meridian/infrastructure/v1/list_internet_outages.proto:page_size',
  'meridian/infrastructure/v1/list_internet_outages.proto:cursor',
  'meridian/intelligence/v1/search_gdelt_documents.proto:timespan',
  'meridian/intelligence/v1/search_gdelt_documents.proto:tone_filter',
  'meridian/intelligence/v1/search_gdelt_documents.proto:sort',
  'meridian/maritime/v1/list_navigational_warnings.proto:page_size',
  'meridian/maritime/v1/list_navigational_warnings.proto:cursor',
  'meridian/market/v1/get_sector_summary.proto:period',
  'meridian/market/v1/list_earnings_calendar.proto:fromDate',
  'meridian/market/v1/list_earnings_calendar.proto:toDate',
  'meridian/military/v1/get_theater_posture.proto:theater',
  'meridian/military/v1/list_military_flights.proto:operator',
  'meridian/military/v1/list_military_flights.proto:aircraft_type',
  'meridian/natural/v1/list_natural_events.proto:days',
  'meridian/prediction/v1/list_prediction_markets.proto:cursor',
  'meridian/research/v1/list_arxiv_papers.proto:cursor',
  'meridian/research/v1/list_arxiv_papers.proto:query',
  'meridian/seismology/v1/list_earthquakes.proto:start',
  'meridian/seismology/v1/list_earthquakes.proto:end',
  'meridian/seismology/v1/list_earthquakes.proto:cursor',
  'meridian/seismology/v1/list_earthquakes.proto:min_magnitude',
  'meridian/trade/v1/get_trade_barriers.proto:countries',
  'meridian/trade/v1/get_trade_barriers.proto:measure_type',
  'meridian/trade/v1/get_trade_restrictions.proto:countries',
  'meridian/unrest/v1/list_unrest_events.proto:page_size',
  'meridian/unrest/v1/list_unrest_events.proto:cursor',
  'meridian/unrest/v1/list_unrest_events.proto:min_severity',
  'meridian/unrest/v1/list_unrest_events.proto:ne_lat',
  'meridian/unrest/v1/list_unrest_events.proto:ne_lon',
  'meridian/unrest/v1/list_unrest_events.proto:sw_lat',
  'meridian/unrest/v1/list_unrest_events.proto:sw_lon',
  'meridian/wildfire/v1/list_fire_detections.proto:start',
  'meridian/wildfire/v1/list_fire_detections.proto:end',
  'meridian/wildfire/v1/list_fire_detections.proto:page_size',
  'meridian/wildfire/v1/list_fire_detections.proto:cursor',
  'meridian/wildfire/v1/list_fire_detections.proto:ne_lat',
  'meridian/wildfire/v1/list_fire_detections.proto:ne_lon',
  'meridian/wildfire/v1/list_fire_detections.proto:sw_lat',
  'meridian/wildfire/v1/list_fire_detections.proto:sw_lon',
]);
...
function handlerPathForProto(root, protoFile) {
  ...
  if (parts[0] !== 'meridian' || parts.length < 4) return null;
