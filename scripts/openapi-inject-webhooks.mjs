...
const WEBHOOKS_BLOCK = `webhooks:
    ${WEBHOOK_EVENT}:
        post:
            ...
            description: |-
                Meridian POSTs this event to the \`callbackUrl\` you register via
                ...
                confirm it genuinely came from Meridian.
                ...
                https://www.meridian.app/.well-known/webhook-sample.json so you
