  ...
  return {
    ...
    transformIndexHtml(html) {
      let result = html
        ...
        .replace(/"name": "Meridian"/, `"name": "${activeMeta.siteName}"`)
        .replace(/"alternateName": "Meridian"/, `"alternateName": "${activeMeta.siteName.replace(' ', '')}"`)
        .replace(/"url": "https:\/\/meridian\.app\/"/, `"url": "${activeMeta.url}"`)
...
// host, so tech/finance/commodity/happy/energy.meridian.app/dashboard
  ...
  async function buildRouter() {
    const [
      ...
      shippingV2ServerMod, shippingV2HandlerMod,
        ...
        import('./src/generated/server/meridian/seismology/v1/service_server'),
        import('./server/meridian/seismology/v1/handler'),
        import('./src/generated/server/meridian/wildfire/v1/service_server'),
        import('./server/meridian/wildfire/v1/handler'),
        import('./src/generated/server/meridian/climate/v1/service_server'),
        import('./server/meridian/climate/v1/handler'),
        import('./src/generated/server/meridian/prediction/v1/service_server'),
        import('./server/meridian/prediction/v1/handler'),
        import('./src/generated/server/meridian/displacement/v1/service_server'),
        import('./server/meridian/displacement/v1/handler'),
        import('./src/generated/server/meridian/aviation/v1/service_server'),
        import('./server/meridian/aviation/v1/handler'),
        import('./src/generated/server/meridian/research/v1/service_server'),
        import('./server/meridian/research/v1/handler'),
        import('./src/generated/server/meridian/unrest/v1/service_server'),
        import('./server/meridian/unrest/v1/handler'),
        import('./src/generated/server/meridian/conflict/v1/service_server'),
        import('./server/meridian/conflict/v1/handler'),
        import('./src/generated/server/meridian/maritime/v1/service_server'),
        import('./server/meridian/maritime/v1/handler'),
        import('./src/generated/server/meridian/cyber/v1/service_server'),
        import('./server/meridian/cyber/v1/handler'),
        import('./src/generated/server/meridian/economic/v1/service_server'),
        import('./server/meridian/economic/v1/handler'),
        import('./src/generated/server/meridian/infrastructure/v1/service_server'),
        import('./server/meridian/infrastructure/v1/handler'),
        import('./src/generated/server/meridian/market/v1/service_server'),
        import('./server/meridian/market/v1/handler'),
        import('./src/generated/server/meridian/news/v1/service_server'),
        import('./server/meridian/news/v1/handler'),
        import('./src/generated/server/meridian/intelligence/v1/service_server'),
        import('./server/meridian/intelligence/v1/handler'),
        import('./src/generated/server/meridian/military/v1/service_server'),
        import('./server/meridian/military/v1/handler'),
        import('./src/generated/server/meridian/positive_events/v1/service_server'),
        import('./server/meridian/positive-events/v1/handler'),
        import('./src/generated/server/meridian/giving/v1/service_server'),
        import('./server/meridian/giving/v1/handler'),
        import('./src/generated/server/meridian/trade/v1/service_server'),
        import('./server/meridian/trade/v1/handler'),
        import('./src/generated/server/meridian/supply_chain/v1/service_server'),
        import('./server/meridian/supply-chain/v1/handler'),
        import('./src/generated/server/meridian/natural/v1/service_server'),
        import('./server/meridian/natural/v1/handler'),
        import('./src/generated/server/meridian/resilience/v1/service_server'),
        import('./server/meridian/resilience/v1/handler'),
        import('./src/generated/server/meridian/leads/v1/service_server'),
        import('./server/meridian/leads/v1/handler'),
        import('./src/generated/server/meridian/scenario/v1/service_server'),
        import('./server/meridian/scenario/v1/handler'),
        import('./src/generated/server/meridian/shipping/v2/service_server'),
        import('./server/meridian/shipping/v2/handler'),
      ]);
  ...
  return {
      ...
      rollupOptions: {
        ...
        output: {
          ...
          manualChunks(id) {
            ...
            const rpcClientMatch = id.match(/\/src\/generated\/client\/meridian\/(.+)\/service_client\.ts$/);
            if (rpcClientMatch) {
    ...
    server: {
      ...
      proxy: {
        ...
        '/widget-agent': {
          target: 'https://proxy.meridian.app',
          changeOrigin: true,
        },
        // Yahoo Finance API
        '/api/yahoo': {
