  ...
  for (const corridorId of CHINA_LOGISTICS_CORRIDOR_IDS) {
    ...
    signals.push(cycloneAvailable
      ? sourceSignal({
        ...
        publisher: {
          id: 'publisher:meridian-western-pacific-coverage',
          name: 'Meridian Western Pacific hazard coverage',
          type: 'derived',
        },
        sourceUrl: null,
        sourceScope: 'regional',
...
function adaptEnergy(
  ...
  if (!payload) {
    return family('china-energy-spine', [unavailableSignal({
      ...
      publisher: {
        id: 'publisher:meridian-energy-spine',
        name: 'Meridian energy spine',
        type: 'derived',
      },
      sourceUrl: null,
