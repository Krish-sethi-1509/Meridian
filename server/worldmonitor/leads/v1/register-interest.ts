...
export const DESKTOP_AUTH_TIMESTAMP_HEADER = 'x-meridian-desktop-timestamp';
export const DESKTOP_AUTH_SIGNATURE_HEADER = 'x-meridian-desktop-signature';
          ...
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #e0e0e0;">
            ...
            <div style="padding: 40px 32px 0;">
              ...
              <div style="text-align: center; margin-bottom: 36px;">
                <a href="https://meridian.app/dashboard" style="display: inline-block; background: #4ade80; color: #0a0a0a; padding: 14px 36px; text-decoration: none; font-weight: 800; font-size: 13px; text-transform: uppercase; letter-spacing: 1.5px; border-radius: 2px;">Explore the Free Dashboard</a>
