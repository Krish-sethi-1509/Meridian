...
const PRODUCTION_PATTERNS: RegExp[] = [
  ...
  //   meridian-git-<branch>-eliewm.vercel.app  (git-branch alias)
  //   meridian-<hash>-eliewm.vercel.app        (deployment URL)
...
const ALLOWED_HEADERS = [
  ...
  'X-Widget-Key',
  'X-Pro-Key',
  'X-Meridian-Desktop-Timestamp',
  'X-Meridian-Desktop-Signature',
  'Idempotency-Key',
  'Mcp-Session-Id',
...
const EXPOSED_HEADERS = [
  ...
  'X-RateLimit-Reset',
  'X-Meridian-Bbox',
  'X-Meridian-Bbox-Missing',
  'X-Meridian-Bbox-Invalid',
  'X-Military-Bbox',
].join(', ');
