...
} from '../../api/_user-api-key.js';
// @ts-expect-error — JS module, no declaration file
import { redisPipeline } from '../../api/_upstash-json.js';
import { unwrapEnvelope } from '../../api/_seed-envelope.js';
import {
...
import { deliverBootstrapR2Shadow, deriveExecutionRegion } from '../../api/_usage-telemetry.js';
...
// pin ACAO: meridian.app on cached responses, breaking CORS for preview deployments.
...
function finishBootstrapR2ShadowResponse(req, ctx, tier, response, redisDurationMs) {
  ...
  response.headers.set('X-Meridian-Bootstrap-Redis-Duration', serializedRedisDurationMs);
...
export { isPublicTierBootstrapRequest } from '../../api/_bootstrap-public-tier.js';
