...
export default function handler(req, res) {
  const url = new URL(req.url, 'https://meridian.app');
  ...
  const baseUrl = 'https://meridian.app';
  ...
  const title = `${countryName} Intelligence Brief | Meridian`;
...
<head>
  ...
  <meta name="twitter:site" content="@MeridianApp"/>
