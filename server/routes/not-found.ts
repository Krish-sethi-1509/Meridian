...
export default function handler(req: Request): Response {
  ...
  const body = {
    error: {
      ...
      hint: 'Check the endpoint path against the OpenAPI spec at https://meridian.app/openapi.yaml or the API reference at https://www.meridian.app/docs/api-reference.',
    },
    documentation: 'https://www.meridian.app/docs/api-reference',
  };
