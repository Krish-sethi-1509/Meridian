...
import { getRelayBaseUrl, getRelayHeaders, fetchWithTimeout } from '../../api/_relay.js';
import { isAllowedDomain, hostMatchForms } from '../../api/_rss-allowed-domain-match.js';
...
async function fetchViaRailway(feedUrl, timeoutMs) {
  ...
  return fetchWithTimeout(relayUrl, {
    headers: getRelayHeaders({
      'Accept': 'application/rss+xml, application/xml, text/xml, */*',
      'User-Agent': 'Meridian-RSS-Proxy/1.0',
    }),
  }, timeoutMs);
}
