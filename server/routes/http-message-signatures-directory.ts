 ...
 *
 * Publishes Meridian's Ed25519 bot-signing public key as a JWK Set so a
 * server receiving a Meridian-originated automated request can fetch this
...
import { guardMetadataMethod } from '../../api/_agent-metadata';
