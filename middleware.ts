...
const VARIANT_OG: Record<string, { name: string; title: string; description: string; image: string; url: string }> = {
  tech: {
    ...
    url: 'https://tech.meridian.app/dashboard',
  },
  finance: {
    ...
    url: 'https://finance.meridian.app/dashboard',
  },
  commodity: {
    ...
    url: 'https://commodity.meridian.app/dashboard',
  },
  happy: {
    name: 'Happy Monitor',
    ...
    url: 'https://happy.meridian.app/dashboard',
  },
  energy: {
    name: 'Energy Atlas',
    ...
    url: 'https://energy.meridian.app/dashboard',
  },
};
...
<ul>
<li><a href="https://www.meridian.app/dashboard">Meridian — geopolitics &amp; intelligence</a></li>
<li><a href="https://tech.meridian.app/dashboard">Tech Monitor</a></li>
<li><a href="https://finance.meridian.app/dashboard">Finance Monitor</a></li>
<li><a href="https://commodity.meridian.app/dashboard">Commodity Monitor</a></li>
<li><a href="https://happy.meridian.app/dashboard">Happy Monitor</a></li>
<li><a href="https://www.meridian.app/pro">Meridian Pro</a></li>
<li><a href="https://www.meridian.app/blog/">Blog</a></li>
...
<title>${eTitle}</title>${jsonLd}
  ...
  // canonical URL is apex (`https://meridian.app/mcp`), and the Cloudflare
  ...
  if (
    ...
    return new Response(null, {
      status: 308,
      headers: {
        Location: 'https://meridian.app/mcp',
  ...
  const apiKey =
    request.headers.get('x-meridian-key') ??
