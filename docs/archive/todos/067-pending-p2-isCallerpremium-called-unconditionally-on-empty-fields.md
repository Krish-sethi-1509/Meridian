...
## Technical Details
- Files: `server/meridian/news/v1/summarize-article.ts:42`, `server/meridian/intelligence/v1/deduct-situation.ts:26`, `server/meridian/intelligence/v1/get-country-intel-brief.ts`
