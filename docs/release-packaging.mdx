...
description: "Reproducible local packaging steps for both desktop variants — full (Meridian) and tech (Tech Monitor) — including signing and notarization."
---
...
- Full variant: `Meridian` / `meridian`
