...
description: "How maintainers publish the meridian npm CLI from cli/ using cli-v* tags, npm trusted publishing, and the release workflow's dry-run gates."
---
...
- The `meridian` package already exists on npm.
