...
description: "Detailed reference for Meridian scoring formulas, detection algorithms, and classification pipelines used across every intelligence module."
---
