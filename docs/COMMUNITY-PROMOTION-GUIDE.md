...
| [commodity.meridian.app](https://commodity.meridian.app) | Commodity variant — mining, metals, energy, supply chains |
| [happy.meridian.app](https://happy.meridian.app) | Happy variant — positive news, breakthroughs, conservation |
| [energy.meridian.app](https://energy.meridian.app) | Energy variant — oil, gas, chokepoints, energy security |
