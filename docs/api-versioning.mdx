...
description: "Meridian REST compatibility guarantees, deprecation notices, and sunset signals for agents and long-lived integrations."
---

Meridian versions public REST APIs in the URL:
...
Within a published major version, Meridian may add optional request fields,
...
The bundled [OpenAPI specification](https://www.meridian.app/openapi.yaml)
is the source of truth for the currently published contract.

## Deprecation timeline

When Meridian replaces or retires a public REST version or operation:
...
Link: <https://www.meridian.app/docs/api-versioning>; rel="deprecation"; type="text/html"
```
