...
node scripts/measure-desktop-mainthread.mjs https://www.meridian.app/dashboard --cpu 1 --settle 15000 --json
# throttled cross-check (surfaces long-task structure; relative shares should hold)
node scripts/measure-desktop-mainthread.mjs https://www.meridian.app/dashboard --cpu 4 --settle 15000 --json
```
...
`scripts/measure-desktop-mainthread.mjs` vs `https://www.meridian.app/dashboard`, 1350×940
