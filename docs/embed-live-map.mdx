...
description: "Embed the public Meridian live map in an article, dashboard, or internal page with a single iframe snippet — sizing, params, and examples."
---

Meridian exposes a public map-only iframe at `/embed`.
...
Each embed includes a permanent attribution link back to Meridian with source campaign parameters.
