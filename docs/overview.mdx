...
description: "Meridian platform variants, capabilities, and specialized monitoring configurations for geopolitical and technology intelligence."
---
Meridian runs six specialized variants from a single codebase, each optimized for different monitoring needs.
...
| **😊 Happy Monitor** | [happy.meridian.app](https://happy.meridian.app) | Curated positive news, global progress tracking, science breakthroughs, conservation wins |
| **💰 Finance Monitor** | [finance.meridian.app](https://finance.meridian.app) | Global markets, stock exchanges, central banks, commodities, forex, crypto, economic indicators |
| **⛏️ Commodity Monitor** | [commodity.meridian.app](https://commodity.meridian.app) | Commodity markets, mining sites, processing plants, supply chains, trade flows |
| **⚡ Energy Monitor** | [energy.meridian.app](https://energy.meridian.app) | Oil & gas pipelines, storage facilities, tanker positions, chokepoints, energy infrastructure and shocks |
...
The finance variant ([finance.meridian.app](https://finance.meridian.app)) provides specialized layers for global financial markets and economic intelligence.
...
The commodity variant ([commodity.meridian.app](https://commodity.meridian.app)) focuses on mining, metals, energy commodities, and critical mineral supply chains.
...
The happy variant ([happy.meridian.app](https://happy.meridian.app)) curates positive news, human progress data, and uplifting stories.
