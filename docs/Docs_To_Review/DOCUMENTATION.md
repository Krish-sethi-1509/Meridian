...
🌐 **[Live Demo: meridian.app](https://meridian.app)** | 💻 **[Tech Variant: tech.meridian.app](https://tech.meridian.app)**
...
![Meridian Dashboard](images/new-meridian.png)

## Platform Variants

Meridian runs two specialized variants from a single codebase, each optimized for different monitoring needs:

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 Meridian** | [meridian.app](https://meridian.app) | Geopolitical intelligence, military tracking, conflict monitoring, infrastructure security |
| **💻 Tech Monitor** | [tech.meridian.app](https://tech.meridian.app) | Technology sector intelligence, AI/startup ecosystems, cloud infrastructure, tech events |
...
The tech variant ([tech.meridian.app](https://tech.meridian.app)) provides specialized layers for technology sector monitoring.
...
The Service Status panel tracks the operational health of external services that Meridian users may depend on.
...
// App.ts
const header = `Meridian v${__APP_VERSION__}`;
```
...
- ✅ **Variant Switcher UI** - Compact orbital navigation between Meridian and Tech Monitor
