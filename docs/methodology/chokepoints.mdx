...
description: "How Meridian scores 13 monitored maritime chokepoints, including the seven-item live-flow subset backed by EIA energy baseline volumes."
---

## What we track

Meridian has **13 monitored waterways** in the canonical chokepoint registry and the
...
`server/meridian/supply-chain/v1/get-chokepoint-status.ts` and weighted in
`server/meridian/supply-chain/v1/_scoring.mjs`.
