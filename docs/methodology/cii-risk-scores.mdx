...
(proto `meridian.intelligence.v1.GetRiskScoresResponse`).

These weights are **editorial** — authored by the Meridian intelligence
...
> `server/meridian/intelligence/v1/_risk-config.ts`, an update to this
...
`server/meridian/intelligence/v1/get-risk-scores.ts`. Each `CiiScore`
therefore exposes:
