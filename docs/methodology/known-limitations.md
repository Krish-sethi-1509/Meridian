...
- Scorer reads: `server/meridian/resilience/v1/_dimension-scorers.ts`
...
- Seeder: `scripts/seed-resilience-static.mjs` lines 658-680
  ...
  `buildAquastatWbMap`)
- Scorer reads:
  `server/meridian/resilience/v1/_dimension-scorers.ts`
...
`server/meridian/resilience/v1/_dimension-scorers.ts` are retained
