...
- Scorer: `server/meridian/resilience/v1/_dimension-scorers.ts` (`scoreFinancialSystemExposure`)
- Indicator registry: `server/meridian/resilience/v1/_indicator-registry.ts` (4 entries with dimension `financialSystemExposure`)
