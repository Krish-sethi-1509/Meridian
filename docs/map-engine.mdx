---
title: "Map Engine"
description: "How Meridian renders the 3D globe and flat map — textures, shaders, clustering, camera controls, and mobile touch gesture handling."
---
