...
description: "Planned public revision log for Energy Atlas registries, tracking every evidence change and public-badge transition — spec-only, not yet live."
---
...
Meridian's Energy Atlas publishes evidence bundles — not opinions —
...
- **Evidence bundles on every asset.** Click any pipeline, storage
  facility, or shortage pin on the [Energy Atlas](https://energy.meridian.app)
...
- An automated correction-intake pipeline. If you spot something
  ...
  [meridian.app](https://meridian.app) or open a GitHub issue
