...
| `power_energy` | Meridian energy spine | National China energy dependency coverage, latest source observation time, and the observed year-over-year oil-product demand change with its own period end when published |
...
regional. Meridian energy spine, UN Comtrade, and Shanghai Shipping
