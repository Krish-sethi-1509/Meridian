...
const bootReq = () => new Request(BOOT_URL, { method: 'GET', headers: { Origin: 'https://meridian.app' } });
...
test('emits an allowlisted event with outcome kv on a fresh value', async () => {
  ...
  try {
    ...
    assert.equal(requestInit.headers['User-Agent'], 'Meridian Bootstrap KV Shadow/1.0');
