...
export const PRO_LAUNCH_FROM = "Elie from Meridian <news@meridian.app>";
export const PRO_LAUNCH_REPLY_TO = "elie@meridian.app";
export const PRO_LAUNCH_SUBJECT = "You waitlisted Meridian PRO. It's now live.";
...
export const PRO_LAUNCH_PHYSICAL_ADDRESS = "Meridian FZ LLC, Dubai - United Arab Emirates";
 ...
 */
export const PRO_LAUNCH_TEXT = `I'm Elie, founder of Meridian. PRO launched today (https://meridian.app/pro). I'm writing because you signed up a month ago, when the product was smaller and different.

Here's what it is now.

Meridian stopped being only a real-time monitoring dashboard, though it still excels at that. It's also a research tool now. It tracks what's happening, and it forecasts what happens next: scenario probabilities on conflicts, market reactions to headlines, supply-chain shock paths, country stability trajectories. You read the present and stress-test the future in the same place.
...
<p>I'm Elie, founder of Meridian. <a href="https://meridian.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=opener" style="color:#0066cc;">PRO launched today</a>. I'm writing because you signed up a month ago, when the product was smaller and different.</p>
<p>Here's what it is now.</p>
<p>Meridian stopped being only a real-time monitoring dashboard, though it still excels at that. It's also a research tool now. It tracks what's happening, and it forecasts what happens next: scenario probabilities on conflicts, market reactions to headlines, supply-chain shock paths, country stability trajectories. You read the present and stress-test the future in the same place.</p>
