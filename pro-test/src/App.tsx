    ...
    ensureClerk()
      .then((clerk) => {
        ...
        clerk.mountUserButton(el, {
          afterSignOutUrl: 'https://www.meridian.app/pro',
        });
      })
      .catch((err) => {
    ...
    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
      ...
      <div className="bg-[#1a1d21] rounded-lg border border-[#35373b] overflow-hidden shadow-2xl sticky top-24">
        <div className="bg-[#222529] px-4 py-3 border-b border-[#35373b] flex items-center gap-3">
          ...
          <span className="ml-2 font-mono text-xs text-gray-400">#meridian-alerts</span>
        </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <div className="flex items-baseline gap-2 mb-1">
                <span className="font-bold text-gray-200">Meridian</span>
    ...
    <footer className="border-t border-wm-border bg-[#020202] py-8 px-6 text-center">
      <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto text-xs text-wm-muted font-mono">
        ...
        <div className="flex items-center gap-6">
          ...
          <a href="https://www.meridian.app/blog/" className="hover:text-wm-text transition-colors">Blog</a>
          <a href="https://www.meridian.app/docs" className="hover:text-wm-text transition-colors">Docs</a>
          <a href="https://status.meridian.app/" target="_blank" rel="noreferrer" className="hover:text-wm-text transition-colors">Status</a>
        ...
        <span className="text-[10px] opacity-40 mt-4 md:mt-0">&copy; {new Date().getFullYear()} Meridian</span>
      </div>
    </footer>
  </div>
);
