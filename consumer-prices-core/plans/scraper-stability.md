...
- src/snapshots/meridian.ts: retailer spread query — add AND pm.pin_disabled_at IS NULL
...
snapshots/meridian.ts buildRetailerSpreadSnapshot:
...
In meridian repo: src/services/consumer-prices/index.ts
...
21. Separate PR in meridian repo: remove ke from MARKETS (Task 11)
