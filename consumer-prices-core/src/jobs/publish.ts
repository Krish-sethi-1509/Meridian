/**
 * Publish job: builds compact Meridian snapshot payloads and writes to Redis.
 * Runs as an independent Railway cron service (02:30 UTC daily) after aggregate.
 * This is the handoff point between consumer-prices-core and Meridian.
 */
import {
...
export async function publishAll() {
  ...
  for (const marketCode of markets) {
    ...
    try {
      ...
      // for real coverage, so Meridian health leaves its bounded
