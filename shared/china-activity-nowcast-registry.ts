...
export const CHINA_ACTIVITY_PROXY_REGISTRY: readonly Readonly<ChinaActivityProxyDefinition>[] =
  Object.freeze([
    ...
    proxyDefinition({
      ...
      source: {
        publisherId: 'publisher:meridian-energy-spine',
        publisherName: 'Meridian energy spine',
        url: 'https://www.meridian.app/docs/data-sources',
    ...
    proxyDefinition({
      ...
      freshnessBudgetMinutes: 72 * 60,
      source: {
        publisherId: 'publisher:meridian-china-corridors',
        publisherName: 'Meridian China corridor control towers',
        url: 'https://www.meridian.app/docs/data-sources',
