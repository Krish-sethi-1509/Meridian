...
export const REPORT = {
  ...
  topicJustification: [
    'Issue #5667 recorded a 2026-07-26 spot check in which Meridian was absent from returned results for “Strait of Hormuz live traffic tracker” — the exact reviewed query q07 in the visibility baseline (use-case intent, chokepoints page family, IMF PortWatch as named source).',
  ...
  // Claims here are attributed to their source and are NOT Meridian
  // observations.
  newsContext: [
    {
      claim:
  ...
  sections: [
    ...
    },
    {
      ...
      block: 'news-context',
      paragraphs: [
        'Meridian does not independently verify the events below; they are third-party reporting, listed with source and dates, and kept separate from the observed transit data above.',
      ],
    },
    {
      id: 'methodology',
