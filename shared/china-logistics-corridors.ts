...
const yrdNodes = [
  ...
  node('yrd-industry-shanghai', 'Shanghai advanced manufacturing cluster', 'industrial', 31.2304, 121.4737, 'Reviewed Meridian configuration'),
  node('yrd-industry-suzhou', 'Suzhou industrial cluster', 'industrial', 31.2989, 120.5853, 'Reviewed Meridian configuration'),
  node('yrd-industry-ningbo', 'Ningbo-Zhoushan industrial cluster', 'industrial', 29.8683, 121.5440, 'Reviewed Meridian configuration'),
] as const;
...
const gbaNodes = [
  ...
  node('gba-industry-shenzhen', 'Shenzhen technology manufacturing cluster', 'industrial', 22.5431, 114.0579, 'Reviewed Meridian configuration'),
  node('gba-industry-guangzhou', 'Guangzhou-Foshan industrial cluster', 'industrial', 23.1291, 113.2644, 'Reviewed Meridian configuration'),
  node('gba-industry-hong-kong', 'Hong Kong trade and finance gateway', 'industrial', 22.3193, 114.1694, 'Reviewed Meridian configuration'),
] as const;
...
const bohaiNodes = [
  ...
  node('bohai-industry-beijing-tianjin', 'Beijing-Tianjin industrial cluster', 'industrial', 39.50, 117.20, 'Reviewed Meridian configuration'),
  node('bohai-industry-shandong', 'Shandong manufacturing cluster', 'industrial', 36.6512, 117.1201, 'Reviewed Meridian configuration'),
  node('bohai-industry-liaoning', 'Liaoning heavy-industry cluster', 'industrial', 41.8057, 123.4315, 'Reviewed Meridian configuration'),
] as const;
...
const westernNodes = [
  ...
  node('western-crossing-khorgos', 'Khorgos land crossing', 'crossing', 44.2140, 80.4100, 'Reviewed Meridian configuration'),
  node('western-crossing-alashankou', 'Alashankou land crossing', 'crossing', 45.1700, 82.5700, 'Reviewed Meridian configuration'),
  node('western-crossing-pingxiang', 'Pingxiang land crossing', 'crossing', 22.1080, 106.7560, 'Reviewed Meridian configuration'),
  node('western-industry-chengdu', 'Chengdu manufacturing cluster', 'industrial', 30.5728, 104.0668, 'Reviewed Meridian configuration'),
  node('western-industry-chongqing', 'Chongqing manufacturing cluster', 'industrial', 29.5630, 106.5516, 'Reviewed Meridian configuration'),
  node('western-industry-urumqi', 'Ürümqi western logistics hub', 'industrial', 43.8256, 87.6168, 'Reviewed Meridian configuration'),
] as const;
