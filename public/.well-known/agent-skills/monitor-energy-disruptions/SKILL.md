...
- Via MCP, use the energy-intelligence or supply-chain tool set on `https://meridian.app/mcp`.

## References

- OpenAPI: https://meridian.app/openapi.json - operation `ListEnergyDisruptions`.
- Methodology: https://www.meridian.app/docs/methodology/disruptions
