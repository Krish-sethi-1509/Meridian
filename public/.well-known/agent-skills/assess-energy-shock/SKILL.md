...
- Via MCP, use the energy or supply-chain tools on `https://meridian.app/mcp` and include the same country/chokepoint parameters.

## References

- OpenAPI: https://meridian.app/openapi.json - operation `ComputeEnergyShockScenario`.
