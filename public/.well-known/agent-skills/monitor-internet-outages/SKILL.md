...
- Via MCP, the equivalent tool is `get_infrastructure_status` on `https://meridian.app/mcp`.

## References

- OpenAPI: https://meridian.app/openapi.json — operation `ListInternetOutages`.
