...
Use this skill when the user asks about recent earthquakes: where, how strong, how deep — plus Meridian's concern scoring, which flags events near known nuclear test sites (shallow low-magnitude events at test sites read very differently from tectonic quakes).
...
- Via MCP, the equivalent tool is `get_natural_disasters` on `https://meridian.app/mcp`.

## References

- OpenAPI: https://meridian.app/openapi.json — operation `ListEarthquakes`.
