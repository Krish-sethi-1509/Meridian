...
- Via MCP, use the health or advisories tools on `https://meridian.app/mcp`.

## References

- OpenAPI: https://meridian.app/openapi.json - operations `ListDiseaseOutbreaks` and `ListAirQualityAlerts`.
