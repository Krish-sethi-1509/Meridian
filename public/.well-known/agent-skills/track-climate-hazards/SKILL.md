...
- Via MCP, use the climate or disaster intelligence tools on `https://meridian.app/mcp`.

## References

- OpenAPI: https://meridian.app/openapi.json - operations `ListClimateDisasters`, `ListClimateAnomalies`, and `ListClimateNews`.
