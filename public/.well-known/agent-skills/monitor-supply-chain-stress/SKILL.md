...
- Via MCP, the equivalent supply-chain surface is available through `https://meridian.app/mcp`.

## References

- OpenAPI: https://meridian.app/openapi.json - operation `GetShippingStress`.
