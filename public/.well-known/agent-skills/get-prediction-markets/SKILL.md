...
- For Meridian's own model-generated scenario forecasts, use `GET /api/forecast/v1/get-forecasts`.
- Via MCP, the equivalent tool is `get_prediction_markets` on `https://meridian.app/mcp`.

## References

- OpenAPI: https://meridian.app/openapi.json — operation `ListPredictionMarkets`.
