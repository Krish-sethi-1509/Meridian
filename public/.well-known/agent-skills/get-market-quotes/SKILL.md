...
Use this skill when the user asks for current market prices — a specific ticker, a set of symbols, or a general "how are markets doing" snapshot. Returns price, change, and a short sparkline series per symbol from Meridian's curated market cache.
...
- Via MCP, the equivalent tool is `get_market_data` on `https://meridian.app/mcp`.

## References

- OpenAPI: https://meridian.app/openapi.json — operation `ListMarketQuotes`.
