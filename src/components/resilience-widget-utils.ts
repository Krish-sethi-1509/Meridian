...
// server/meridian/resilience/v1/_dimension-scorers.ts). Duplicated
...
// `server/meridian/resilience/v1/_dimension-scorers.ts`. When a dim
...
// Mirrors server/meridian/resilience/v1/_shared.ts. Keep this table
...
// server/meridian/resilience/v1/_dimension-scorers.ts. The doc
