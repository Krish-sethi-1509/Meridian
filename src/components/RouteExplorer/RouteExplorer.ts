...
import type { GetRouteExplorerLaneResponse, GetRouteImpactResponse, BypassCorridorOption } from '@/generated/server/meridian/supply_chain/v1/service_server';
    ...
    if (this.contentEl) {
      ...
      btn?.addEventListener('click', () => {
        ...
        void import('@/services/checkout')
          ...
          .catch(() => window.open('https://meridian.app/pro', '_blank', 'noopener,noreferrer'));
      }, { once: true });
    }
  }
