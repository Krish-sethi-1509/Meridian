...
import type { ListFeedDigestResponse } from '@/generated/client/meridian/news/v1/service_client';
import type { GetSectorSummaryResponse, ListMarketQuotesResponse, ListCommodityQuotesResponse } from '@/generated/client/meridian/market/v1/service_client';
import type {
  AiTokensPanel,
  CommoditiesPanel,
  CryptoHeatmapPanel,
...
import type { NewsItem as ProtoNewsItem } from '@/generated/client/meridian/news/v1/service_client';
...
export class DataLoaderManager implements AppModule {
  ...
  private async _collectRegimeContext(): Promise<RegimeMacroContext | undefined> {
    try {
      ...
      const { MarketServiceClient } = await import('@/generated/client/meridian/market/v1/service_client');
  ...
  private async _collectYieldCurveContext(): Promise<YieldCurveContext | undefined> {
    try {
      const { EconomicServiceClient } = await import('@/generated/client/meridian/economic/v1/service_client');
      const { getRpcBaseUrl } = await import('@/services/rpc-client');
  ...
  async loadForecasts(): Promise<void> {
    try {
      const hydrated = getHydratedData('forecasts') as { predictions?: import('@/generated/client/meridian/forecast/v1/service_client').Forecast[]; generatedAt?: number } | undefined;
  ...
  async loadEconomicStress(): Promise<void> {
    try {
      ...
      const hydrated = getHydratedData('economicStress') as import('@/generated/client/meridian/economic/v1/service_client').GetEconomicStressResponse | undefined;
