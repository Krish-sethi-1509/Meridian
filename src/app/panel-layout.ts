...
const CW_PRO_GATE_TAB_RECOVERY_KEY = 'meridian-cw-pro-gate-tab-recovery-v1';
...
export class PanelLayoutManager implements AppModule {
  ...
  async renderLayout(): Promise<void> {
    ...
    const referenceLinksHtml = DASHBOARD_REFERENCE_LINKS.map(({ label, path }) => {
      const href = this.ctx.isDesktopApp ? `https://www.meridian.app${path}` : path;
    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', 'https://meridian.app/dashboard')}"
            ...
            <a href="${vHref('tech', 'https://tech.meridian.app/dashboard')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('finance', 'https://finance.meridian.app/dashboard')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('commodity', 'https://commodity.meridian.app/dashboard')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('energy', 'https://energy.meridian.app/dashboard')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('happy', 'https://happy.meridian.app/dashboard')}"
          ...
          <span class="logo">MONITOR</span><span class="logo-mobile">Meridian</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-menu-footer-links">
          ${referenceLinksHtml}
          <a href="${this.ctx.isDesktopApp ? 'https://www.meridian.app/pro#pricing' : '/pro#pricing'}" target="_blank" rel="noopener">Pricing</a>
          <a href="${this.ctx.isDesktopApp ? 'https://meridian.app/blog/' : 'https://www.meridian.app/blog/'}" target="_blank" rel="noopener">Blog</a>
          <a href="${this.ctx.isDesktopApp ? 'https://meridian.app/docs' : 'https://www.meridian.app/docs'}" target="_blank" rel="noopener">Docs</a>
          <a href="https://status.meridian.app/" target="_blank" rel="noopener">Status</a>
        </div>
      ...
      <footer class="site-footer">
        ...
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} Meridian</span>
      </footer>
