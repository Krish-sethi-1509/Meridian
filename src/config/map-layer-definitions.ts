...
export const LAYER_EXPLANATIONS: Partial<Record<keyof MapLayers, LayerExplanation>> = {
  conflicts: {
    ...
    source: 'Meridian conflict-zone registry, UCDP/ACLED conflict context, and documented boundary metadata such as the Korean DMZ.',
  ...
  ciiChoropleth: {
    ...
    source: 'Meridian CII scoring service using conflict, unrest, advisories, cyber, AIS, aviation, natural-event, and news signals.',
  ...
  ais: {
    ...
    source: 'AISStream relay snapshots, Meridian maritime service, and chokepoint disruption classifiers.',
  ...
  waterways: {
    ...
    source: 'Meridian strategic-waterways registry with supply-chain chokepoint status overlays from AIS, NGA warnings, and PortWatch-derived feeds.',
  ...
  tradeRoutes: {
    ...
    source: 'Meridian trade-route registry plus supply-chain chokepoint status and transit summaries.',
  ...
  hotspots: {
    ...
    source: 'Meridian hotspot registry, RSS/GDELT news intelligence, hotspot escalation scoring, military activity, and CII context.',
