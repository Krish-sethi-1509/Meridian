...
export const STORAGE_KEYS = {
  ...
  disabledFeedsSchema: 'meridian-disabled-feeds-schema',
  ...
  newsFeedRotation: 'meridian-news-feed-rotation',
  liveChannels: 'meridian-live-channels',
  mapMode: 'meridian-map-mode',          // 'flat' | 'globe'
  activeChannel: 'meridian-active-channel',
  webcamPrefs: 'meridian-webcam-prefs',
} as const;
