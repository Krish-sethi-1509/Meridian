...
// Energy variant feeds — energy.meridian.app
...
export const INTEL_SOURCES: Feed[] = [
  ...
  // meridian-disabled-feeds and cloud-synced rather than recomputed, so it
 ...
 * the one-shot migration in App.ts (`meridian-frontline-europe-enable-v1`).
 */
