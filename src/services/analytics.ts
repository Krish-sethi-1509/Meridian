...
const UMAMI_SCRIPT_SRC = 'https://abacus.meridian.app/script.js';
...
// data-domains is temporarily reduced to the meridian.app hosts + happy
...
// mechanism that keeps energy.meridian.app silent. Restore tech, finance, and
// commodity once #4183 ships in a tagged release.
//
// www.meridian.app MUST be listed alongside the apex (#4931): the apex 301s
...
const UMAMI_DOMAINS = 'meridian.app,www.meridian.app,happy.meridian.app';
