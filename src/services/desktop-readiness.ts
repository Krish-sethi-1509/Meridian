...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['server/meridian/conflict/v1/handler.ts', 'server/meridian/infrastructure/v1/handler.ts', 'server/meridian/cyber/v1/handler.ts', 'server/meridian/maritime/v1/handler.ts', 'server/meridian/military/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/meridian/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/meridian/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['server/meridian/military/v1/handler.ts'],
    locality: 'api-key',
