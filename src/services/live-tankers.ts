...
//
// The handler-side cache (server/meridian/maritime/v1/get-vessel-snapshot.ts)
...
import type { SnapshotCandidateReport } from '@/generated/client/meridian/maritime/v1/service_client';
