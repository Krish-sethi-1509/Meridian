...
import type { ListDiseaseOutbreaksResponse, DiseaseOutbreakItem } from '@/generated/client/meridian/health/v1/service_client';
...
// in server/meridian/health/v1/list-disease-outbreaks.ts so empty/offline
