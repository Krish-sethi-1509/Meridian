...
const FREE_MAP_PANEL_ACCESS_KEY = 'meridian-free-map-panel-access-v1';
const CW_PRO_GATE_RECOVERY_KEY = 'meridian-cw-pro-gate-recovery-v1';
const CW_PRO_GATE_CLOUD_RECOVERY_BASELINE_KEY = 'meridian-cw-pro-gate-cloud-recovery-baseline-v1';
const CW_PRO_GATE_CLOUD_RECOVERY_APPLIED_KEY = 'meridian-cw-pro-gate-cloud-recovery-applied-v1';
...
export class App {
  ...
  constructor(containerId: string) {
    ...
    const PANEL_SPANS_KEY = 'meridian-panel-spans';
    ...
    try {
      storedVariant = localStorage.getItem('meridian-variant');
    ...
    if (!storageAvailable) {
      ...
      const PANEL_KEY_RENAMES_MIGRATION_KEY = 'meridian-panel-key-renames-v2.6.8';
      ...
      const UNIFIED_MIGRATION_KEY = 'meridian-unified-panels-v1';
      ...
      const HAPPY_PANEL_FIX_KEY = 'meridian-happy-panel-fix-v1';
      ...
      const PANEL_ORDER_MIGRATION_KEY = 'meridian-panel-order-v1.9';
      ...
      if (currentVariant === 'tech') {
        const TECH_INSIGHTS_MIGRATION_KEY = 'meridian-tech-insights-top-v1';
    ...
    if (storageAvailable) {
      ...
      const PANEL_PRUNE_KEY = 'meridian-panel-prune-v1';
      ...
      const LAYOUT_RESET_MIGRATION_KEY = 'meridian-layout-reset-v2.5';
    ...
    if (currentVariant === 'full' && storageAvailable) {
      const baseKey = 'meridian-sources-reduction-v3';
      ...
      const frontlineKey = 'meridian-frontline-europe-enable-v1';
      ...
      const strategicKey = 'meridian-strategic-defaults-enable-v1';
      ...
      const regionalRolloutKey = 'meridian-regional-feed-rollout-reconcile-v1';
      ...
      const canadaArcticKey = 'meridian-canada-arctic-optin-v1';
      ...
      // first run with `userLang='en'` sets `meridian-locale-boost-en` and
      ...
      const localeKey = `meridian-locale-boost-${userLang}`;
  ...
  public async init(): Promise<void> {
    ...
    // on commodity.meridian.app: Trade Policy panel stuck at "Loading…"
