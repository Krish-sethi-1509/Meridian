export const PANEL_SPANS_KEY = 'meridian-panel-spans';
export const PANEL_COL_SPANS_KEY = 'meridian-panel-col-spans';
export const PANEL_COLLAPSED_KEY = 'meridian-panel-collapsed';
