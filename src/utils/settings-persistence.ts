...
const SETTINGS_KEY_PREFIXES: readonly string[] = [
  ...
  'meridian-live-channels',
  'meridian-active-channel',
  'meridian-runtime-feature-toggles',
  'wm-globe-render-scale',
  'wm-live-streams-always-on',
  'meridian-webcam-prefs',
  'wm-map-theme:',
  'map-height',
  'map-pinned',
...
export function exportSettings(): void {
  ...
  const exportData: ExportedSettings = {
    ...
    variant: localStorage.getItem('meridian-variant') || 'full',
    data,
  };
  ...
  a.download = `meridian-settings-${ts}.json`;
